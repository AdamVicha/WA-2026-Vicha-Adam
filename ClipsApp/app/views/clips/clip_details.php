        ...
        ?>
            <div class="flex gap-3">
                <a href="<?= BASE_URL ?>/index.php?url=clip/edit/<?= $clip['id'] ?>" 
                   class="text-amber-500 hover:text-amber-400 font-bold text-sm bg-amber-500/10 px-3 py-1.5 rounded transition flex items-center gap-1">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                    Upravit klip
                </a>
                <a href="<?= BASE_URL ?>/index.php?url=clip/delete/<?= $clip['id'] ?>" 
                   onclick="return confirm('Opravdu chcete toto video trvale smazat?')"
