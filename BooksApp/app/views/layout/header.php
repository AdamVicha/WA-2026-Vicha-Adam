                ...
                <ul class="flex gap-4 m-0 p-0 list-none items-center">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'admin'): ?>
                            <li><a href="<?= BASE_URL ?>/index.php?url=admin/dashboard" class="bg-amber-500 text-white px-4 py-2 rounded-md font-semibold hover:bg-amber-600 transition shadow-sm">Správa uživatelů</a></li>
                        <?php endif; ?>
